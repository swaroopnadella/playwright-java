...
public class postCall2 {
	...
	public static void main(String[] args) {
		...
		payload.put("password", "pistol2");

		APIResponse response = apiRequestContext.post("/api/register", RequestOptions.create().setData(payload));
